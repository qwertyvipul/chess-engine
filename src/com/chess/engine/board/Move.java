...
public abstract class Move {
    ...
    public static class MajorAttackMove extends AttackMove{
        public MajorAttackMove(final Board board,
                               ...
                               final int destinationCoordiante,
                               final Piece pieceAttacked){
            super(board, pieceMoved, destinationCoordiante, pieceAttacked);
        }
    ...
    public static final class PawnEnPassantAttackMove extends PawnAttackMove{
        ...
        public Board execute(){
            ...
            for(final Piece piece : this.board.currentPlayer().getOpponent().getActivePieces()){
                if(!this.equals((this.getAttackedPiece()))){
                    builder.setPiece(piece);
                }
            }
    ...
    public static class PawnPromotion extends Move{
        ...
        @Override
        public int hashCode(){
            return this.decoratedMove.hashCode() +
                    (31 * this.promotedPawn.hashCode());
        }

        @Override
        public boolean equals(final Object other){
            return this == other ||
                    other instanceof PawnPromotion &&
                            (super.equals(other));
        }
    }
    ...
    static abstract class CastleMove extends Move{
        ...
        public Board execute() {
            ...
            builder.setPiece(this.movedPiece.movePiece(this));
            //TODO look into the first move of the normal piece
