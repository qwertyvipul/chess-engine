        ...
        if(this.playerKing.isFirstMove() && !this.isInCheck()){
            ...
            if(!this.board.getTile(5).isTileOccupied() &&
                ...
                if(rookTile.isTileOccupied() && rookTile.getPiece().isFirstMove()){
                    if(Player.calcaulateAttackOnTile(5, opponentLegals).isEmpty() &&
                            Player.calcaulateAttackOnTile(6, opponentLegals).isEmpty() &&
            ...
            if(!this.board.getTile(3).isTileOccupied() &&
                ...
                if(rookTile.isTileOccupied() && rookTile.getPiece().isFirstMove()){
                    if(Player.calcaulateAttackOnTile(3, opponentLegals).isEmpty() &&
                            Player.calcaulateAttackOnTile(2, opponentLegals).isEmpty() &&
                            Player.calcaulateAttackOnTile(1, opponentLegals).isEmpty() &&
                            rookTile.getPiece().getPieceType().isRook()){
